...
Species that spend more time moving *do* travel farther overall as there is a positive trend line. The Daubentonidae and Lorisidae are the only families that exhibit this trend.
...
As seen in the histograms, both variables should be transformed.
...
Species that live in larger groups *do* travel farther overall. The Atelidae, Cebidae, Cercopithecidae, Lepilemuridae, and Pitheciidae families exhibit this trend.
...
Frugivores *do* live in larger groups than foliovores.
